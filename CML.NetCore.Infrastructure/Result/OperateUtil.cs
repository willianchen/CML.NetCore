...
namespace CML.Lib.Result
{
    ...
    public static class OperateUtil
    {
        ...
        /// <returns>操作结果</returns>
        public static OperateResult Execute(Func<OperateResult> executeAction, [CallerMemberName]string callMemberName = null)
        {
            try
            {
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static OperateResult Execute(Action executeAction, string successMessage = null, [CallerMemberName]string callMemberName = null)
        {
            try
            {
                executeAction();
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static async Task<OperateResult> ExecuteAsync(Func<Task<OperateResult>> executeActionAsync, [CallerMemberName] string callMemberName = null)
        {
            try
            {
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static async Task<OperateResult> ExecuteAsync(Func<Task> executeActionAsync, string successMessage = null, [CallerMemberName]string callMemberName = null)
        {
            try
            {
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static OperateResult<T> Execute<T>(Func<OperateResult<T>> executeAction, [CallerMemberName]string callMemberName = null)
        {
            try
            {
                var result = executeAction();
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static OperateResult<T> Execute<T>(Func<T> executeAction, [CallerMemberName]string callMemberName = null)
        {
            try
            {
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static async Task<OperateResult<T>> ExecuteAsync<T>(Func<Task<OperateResult<T>>> executeActionAsync, [CallerMemberName]string callMemberName = null)
        {
            try
            {
        ...
        /// <param name="callMemberName">调用方法名字</param>
        /// <returns>操作结果</returns>
        public static async Task<OperateResult<T>> ExecuteAsync<T>(Func<Task<T>> executeActionAsync, [CallerMemberName]string callMemberName = null)
        {
            try
            {
