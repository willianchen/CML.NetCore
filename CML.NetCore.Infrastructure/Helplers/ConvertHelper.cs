...
namespace CML.Lib.Utils
{
    ...
    public static class ConvertHelper
    {
        ...
        {
            int result;
            var success = int.TryParse(input.ToSafeString(), out result);
            if (success)
                return result;
            try
            {
        ...
        {
            long result;
            var success = long.TryParse(input.ToSafeString(), out result);
            if (success)
                return result;
            try
            {
        ...
        {
            float result;
            var success = float.TryParse(input.ToSafeString(), out result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            double result;
            var success = double.TryParse(input.ToSafeString(), out result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            decimal result;
            var success = decimal.TryParse(input.ToSafeString(), out result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        public static bool? ToBoolOrNull(object input)
        {
            ...
            if (value != null)
                return value.Value;
            bool result;
            return bool.TryParse(input.ToSafeString(), out result) ? (bool?)result : null;
        }
        ...
        {
            DateTime result;
            return DateTime.TryParse(input.ToSafeString(), out result) ? (DateTime?)result : null;
        }
        ...
        {
            Guid result;
            return Guid.TryParse(input.ToSafeString(), out result) ? (Guid?)result : null;
        }
        ...
        public static List<T> ToList<T>(string input, char spirit = ',')
        {
            var result = new List<T>();
            if (string.IsNullOrWhiteSpace(input))
                return result;
            var array = input.Split(spirit);
