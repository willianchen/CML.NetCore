...
namespace CML.Lib.Lock
{
    ...
    public interface ILock
    {
        ...
        /// <returns></returns>
        T ExecuteWithLock<T>(string key, string value, TimeSpan span, Func<T> executeAction, T defaultValue = default(T));
        ...
        /// <param name="defaultValue">默认返回</param>
        /// <returns></returns>
        Task<T> ExecuteWithLockAsync<T>(string key, string value, TimeSpan span, Func<Task<T>> executeAction, T defaultValue = default(T));
    }
}